...
$sql = "SELECT * FROM categories WHERE (name LIKE ? OR slug LIKE ?)";
...
<div class="admin-content">
    <div class="page-header mb-4">
        ...
        <div>
            <a href="addCategory.php" class="btn btn-primary-green">
    ...
    <?php if (isset($_GET['error'])): ?>
        <div class="alert alert-danger alert-dismissible fade show" role="alert">
            ...
            <?php if ($_GET['error'] == 'in_use'): ?>
                <strong>Cannot Delete!</strong> This category is being used by <?php echo htmlspecialchars($_GET['count'] ?? 0); ?> product(s). Please remove or reassign those products first.
            <?php elseif ($_GET['error'] == 'invalid_id'): ?>
                <strong>Error!</strong> Invalid category ID.
            <?php else: ?>
            ...
            <form method="GET" class="filter-form">
                <div class="row g-3">
                    ...
                    <div class="col-md-3 d-flex align-items-end gap-2">
                        ...
                        <a href="categories.php" class="btn btn-outline-secondary flex-fill">Reset</a>
                    </div>
                </div>
            </form>
        </div>
    ...
    <div class="card">
        <div class="card-header d-flex justify-content-between align-items-center">
            ...
            <span class="badge bg-primary-green"><?php echo $result->num_rows; ?> category(ies)</span>
        </div>
